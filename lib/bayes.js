...
(function () {
  ...
  (function buildNav() {
    ...
    var pdf = document.createElement("button"); pdf.type = "button"; pdf.className = "nav-btn pdf-btn"; pdf.title = "PDF"; pdf.setAttribute("aria-label", "Save as PDF");
