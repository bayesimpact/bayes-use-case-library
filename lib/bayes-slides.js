...
(function () {
  ...
  S.earth = function (o) {
    ...
    return '<section class="slide dark earth" id="earth" data-dark>' +
      '<div class="slide-inner"><div class="hero believe-box" id="believeBox">' +
        '<div class="hero-txt">' +
          '<p class="eyebrow">' + bi("Notre mission", "Our mission") + "</p>" +
      ...
      '<div class="split reveal">' +
        "<div>" +
          ...
          '<div class="chips" style="margin-top:16px;">' +
            '<div class="chip"><span class="dot-ok"></span> ' + bi("Découpage &amp; indexation", "Chunking &amp; indexing") + "</div>" +
            '<div class="chip"><span class="dot-ok"></span> ' + bi("Atténuation des biais", "Bias mitigation") + "</div>" +
            '<div class="chip"><span class="dot-ok"></span> ' + bi("Évaluation intégrée", "Built-in evaluation") + "</div>" +
          "</div>" +
        "</div>" +
  ...
  S["platform-compliance"] = function () {
    ...
    function abox(fr, en) {
      return '<div style="flex:1 1 0;min-width:128px;background:var(--card);border:1px solid var(--border-soft);border-radius:11px;padding:11px 12px;box-shadow:var(--shadow);text-align:center;font-size:12.5px;font-weight:600;color:var(--ink-soft);line-height:1.3;">' + bi(fr, en) + "</div>";
    }
    return '<section class="slide" id="platform-compliance" style="background:linear-gradient(to top, rgba(255,132,0,.14) 0%, rgba(255,132,0,.045) 30%, rgba(255,132,0,0) 60%), var(--bg);"><div class="slide-inner">' +
      ...
      '<p class="lead reveal" style="max-width:64ch">' + bi(
        "Le sol, ce sont vos fondations : vos systèmes et votre data. La Bayes Platform se pose dessus et instancie autant d'agents que nécessaire. Tout reste chez vous.",
        "The ground is your foundations: your systems and your data. The Bayes Platform sits on top and spins up as many agents as you need. Everything stays in-house.") + "</p>" +
      '<div class="reveal" style="display:flex;flex-direction:column;margin-top:16px;">' +
        lab("③ Autant d'agents que nécessaire", "③ As many agents as you need", "var(--muted)") +
        '<div style="display:flex;gap:10px;flex-wrap:wrap;">' + abox("Copilote clinicien", "Clinician copilot") + abox("Assistant citoyen", "Citizen assistant") + abox("Analytique métier", "Business analytics") + abox("Coordination de soins", "Care coordination") + abox("↔ DPI / études", "↔ EHR / studies") + "</div>" +
        '<div style="text-align:center;color:var(--accent-orange);font-weight:800;font-size:14px;letter-spacing:10px;padding:7px 0 6px;">↑↑↑</div>' +
        '<div style="background:linear-gradient(180deg, #fff, rgba(255,132,0,.07));border:2px solid var(--accent-orange);border-radius:14px;padding:15px 18px;box-shadow:0 0 0 3px rgba(255,132,0,.10), var(--shadow);">' +
          lab("② Bayes Platform · l'OS agentique", "② Bayes Platform · the agentic OS", "var(--accent-orange)") +
          '<div style="display:flex;gap:8px;flex-wrap:wrap;">' + chip("Orchestration multi-agents", "Multi-agent orchestration") + chip("Ancrage &amp; protocoles", "Grounding &amp; protocols") + chip("Garde-fous &amp; conformité", "Guardrails &amp; compliance") + chip("Observabilité", "Observability") + chip("No-code", "No-code") + "</div>" +
          '<div style="display:flex;align-items:center;gap:9px 12px;flex-wrap:wrap;margin-top:11px;padding-top:11px;border-top:1px solid var(--border-soft);">' +
            '<span style="font-family:\'JetBrains Mono\',monospace;font-size:9px;font-weight:700;letter-spacing:.07em;text-transform:uppercase;color:var(--muted);">' + bi("Sert les derniers modèles · indépendant du fournisseur", "Serves the latest models · provider-independent") + "</span>" +
            chip("Frontier · cloud", "Frontier · cloud") + chip("Open-weight : Gemma · Mistral · Qwen", "Open-weight: Gemma · Mistral · Qwen") +
          "</div>" +
        "</div>" +
        '<div style="text-align:center;padding:6px 0 5px;"><span style="font-family:\'JetBrains Mono\',monospace;font-size:10px;font-weight:700;color:#fff;background:var(--ink);border-radius:999px;padding:5px 13px;">' + bi("posée sur vos fondations · la donnée ne sort jamais", "sits on your foundations · data never leaves") + "</span></div>" +
        '<div style="background:var(--ink);color:#fff;border-radius:14px;padding:15px 18px;">' +
          lab("① Vos fondations · vos systèmes &amp; votre data", "① Your foundations · your systems &amp; data", "rgba(255,255,255,.6)") +
          '<div style="display:flex;gap:8px;flex-wrap:wrap;">' + chip("Ministères", "Ministries", 1) + chip("DPI / EHR", "EHR", 1) + chip("Back-offices", "Back-offices", 1) + chip("Bases métier", "Business databases", 1) + chip("Hébergé chez vous · sécurisé", "Hosted in-house · secured", 1) + "</div>" +
        "</div>" +
      "</div></div></section>";
  };
    ...
    return '<section class="slide" id="platform-evaluation"><div class="slide-inner">' +
      ...
      '<div class="split reveal">' +
        "<div>" +
          ...
          '<div class="chips"><div class="chip"><span class="dot-ok"></span> ' + bi("Relecture à l'aveugle", "Blind review") + "</div>" +
